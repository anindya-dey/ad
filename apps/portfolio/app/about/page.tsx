...
export default function Page() {
  return (
    <div className="px-6 py-20 md:p-10">
      ...
      <div className="md:flex">
        <div className="mt-4">
          <Image
            src={'/about/about.jpg'}
            alt="avatar"
            className="w-full md:w-[600px] md:h-[350px] object-cover overflow-hidden rounded-2xl drop-shadow-md"
            width={250}
            height={250}
          />
        </div>
        <div className="md:flex md:flex-col md:pl-10">
          <div className="mt-4">
            ...
            <div className="py-4 text-gray-700 dark:text-gray-300">
              I am a goal-oriented and mission-driven full-stack software
              developer from India with 8 years+ of industry experience, and
              with an ability to self-manage during independent projects, as
              well as collaborate as part of a productive team.
              <br />
              Currently I am looking for opportunities to work in AI/ML
              projects.
            </div>
          </div>
          <div className="mt-4">
